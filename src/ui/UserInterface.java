...
public class UserInterface {
	...
	public JButton printButton1To10;
	public JButton printButton11To19;
	...
	public UserInterface(){
		...
		printButton1To10 = new JButton("Print Extra Diary Sheet Rooms 1 to 10");
		printButton11To19 = new JButton("Print Diary Sheets");
	...
	public JPanel calendarWindow(){
		...
		GridLayout printLayout = new GridLayout( 2, 1 );
		printPanel.setLayout( printLayout );
		printPanel.add( printButton1To10 );
		printPanel.add( printButton11To19 );
		
		printButton11To19.setEnabled(false);
		
		content.setLayout( new BorderLayout() );
		content.add( resetButton, BorderLayout.NORTH );
		content.add( dateSelectPanel, BorderLayout.CENTER );
		content.add( printPanel, BorderLayout.SOUTH );
 ...
 */
	...
	public static int createOptionDialog( String str ){
    	...
    	int result = JOptionPane.showOptionDialog(null, str, "Alert",
	...
	public void dataSent( String day, String month ){
		...
		if ( ( day == null ) && ( month == null ) ){
			msg = "Printing diary sheet for rooms 1 to 10";
		}else {
			msg = "Data sent to printer for " + day + " " + month;
		}
	    ...
	    if ( ( day == null ) && ( month == null ) ){
	    	printAlert = optionPane.createDialog( null, "alert" );
	    }else{
