...
import model.printing.Rooms11To19;
import model.printing.Rooms1To10;
import ui.*;

public class CrownHotelBookingSheet {
	
	/*
	 * user interface variables
	 */

	private static JFrame window = new JFrame("Crown Hotel Booking Sheet");
	...
	private static void addActionListeners(){
		 ...
		 * printButton1To10
		 * 
		 * print extra sheet for rooms 1 to 10
		 */
		
		ui.printButton1To10.addActionListener( new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				Rooms1To10 sheet = new Rooms1To10();
				int timeout_ms = 5000;//10 * 1000
				Timer timer = new Timer();
				timer.schedule(new CloseDialogTask( sheet ), timeout_ms);
				ui.dataSent( null, null );
			}
		});
		...
		ui.printButton11To19.addActionListener(new ActionListener() {
		    @Override
			public void actionPerformed(ActionEvent e) {
		    	...
		    	str = "Diary Sheets printed for room 1 to 10\n";
		    	str = str + "Set printer up to print on reverse of these sheets\n";
		    	str = str + "Press OK to continue....";
		    	
		    	result = UserInterface.createOptionDialog(str);
		    	
		    	if ( result == UserInterface.getOKJOptionValue() ){
		    		
		    		for( int i = 0; i < listSize; i++){
						Rooms11To19 sheet = new Rooms11To19( dayString.getItem( i ), monthString.getItem( i ) );
						int timeout_ms = 5000;//10 * 1000
						Timer timer = new Timer();
						timer.schedule(new CloseDialogTask( sheet ), timeout_ms);
		...
		UserInterface.endDateJList.addListSelectionListener(new ListSelectionListener(){
			...
			public void valueChanged(ListSelectionEvent e) {
				if ( UserInterface.endDateJList.getValueIsAdjusting() ){
					...
					ui.printButton11To19.setEnabled(true);
				}
			}
	...
	public static void setStartMonthIndex(int startMonthIndex) {
		CrownHotelBookingSheet.startMonthIndex = startMonthIndex;
	}
	...
	public static void setStartDayIndex(int startDayIndex) {
		CrownHotelBookingSheet.startDayIndex = startDayIndex;
	}
	...
	public static void setStartDateIndex(int startDateIndex) {
		CrownHotelBookingSheet.startDateIndex = startDateIndex;
	}
	...
	public static void setEndMonthIndex(int endMonthIndex) {
		CrownHotelBookingSheet.endMonthIndex = endMonthIndex;
	}
	...
	public static void setEndDateIndex(int endDateIndex) {
		CrownHotelBookingSheet.endDateIndex = endDateIndex;
	}
